...
Language: German
Date: 14.07.2021
Translated by: Justinnn, GermanMaKo
---------------------------------------------------------------------------]]
...
lang.NRegistry = {
	...
	scpwait = "Du musst %i Runden warten, um als SCP spielen zu können!",
	abouttostart = "Das Spiel startet in %i Sekunden!",
	kill = "Du hast %d Punkte für das Töten von %s: %s erhalten!",
	assist = "Du hast %d Punkte für die unterstützen der Tötung von: %s erhalten!",
	rdm = "Du hast %d Punkte verloren, weil Du %s: %s getötet hast!",
	acc_denied = "Kein Zugriff",
	acc_granted = "Zugriff gestattet",
	acc_omnitool = "Du benötigst ein Omitool, um diese Tür zu öffnen",
	device_noomni = "Du benötigst ein Omitool, um mit dieses gerät zu interagieren",
	elevator_noomni = "Du benötigst ein Omitool, um diesen Fahrstuhl nutzen zu können",
	acc_wrong = " Du benötigst eine höhere Freigabestufe, um diese Aktion durchführen zu können",
	rxpspec = "Du hast %i Erfahrung für das Spielen auf diesem Server erhalten!",
	rxpplay = "Du hast %i Erfahrung erhalten, weil du noch lebst!",
	rxpplus = "Du hast %i Erfahrung erhalten, weil du mehr als die Hälfte der Runde überlebt hast!",
	roundxp = "Du hast % i Erfahrung für deine Punkte erhalten",
	gateexplode = "Das Gate A wird in %i Sekunden aufgesprengt",
	explodeterminated = "Die Zerstörung von Gate A wurde abgebrochen",
	r106used = "SCP 106 Recontain-Prozedur kann nur einmal pro Runde ausgelöst werden",
	r106eloiid = "Du musst den ELO-IID-Elektromagneten ausschalten, um die SCP 106 Recontain-Prozedur starten zu können",
	r106sound = " Du musst die Soundtransmission anschalten um die SCP 106 Recontain-Prozedur starten zu können",
	r106human = "Ein lebender Mensch wird in der Zelle von  SCP 106 benötigt um die SCP 106 Recontain-Prozedur starten zu können",
	r106already = "SCP 106 ist bereits Recontaint",
	r106success = "Du hast %i Punkte für das Recontainen von SCP 106 erhalten!",
	vestpickup = "Du hast eine Weste aufgehoben",
	vestdrop = "Du hast deine Weste abgelegt",
	hasvest = "Du hast bereits eine Weste! Verwende dein Inventar um sie fallen zu lassen",
	escortpoints = "Du hast %i Punkte für das Eskortieren erhalten",
	femur_act = "Femur Breaker wurde aktiviert...",
	levelup = "Du bist aufgestiegen! Dein aktuelles Level ist %i",
	healplayer = "Du hast %i Punkte für das Heilen eines anderen Spieler erhalten",
	detectscp = "Du hast %i Punkte für das Aufspüren von SCPs erhalten",
	winxp = "Du hast %i Erfahrung erhalten, weil dein erstes Team das Spiel gewonnen hat",
	winalivexp = "Du hast %i Erfahrung erhalten, weil dein Team das Spiel gewonnen hat",
	upgradepoints = "Du hast neue Upgrade-Punkte erhalten! Drücke '% s', um das SCP-Upgrade-Menü zu öffnen",
	prestigeup = "Der Spieler %s hat ein höheres Prestigelevel erreicht! Sein aktuelles Prestigelevel ist: %i",
	omega_detonation = "OMEGA-Gefechtskopf-Detonation in %i Sekunden. Gehe an die Oberfläche oder begeben dich sofort zum Sprengschutz in der LCZ nähe 914!",
	alpha_detonation = "ALPHA-Gefechtskopf-Detonation in %i Sekunden. Gehe in die Facility oder versuche zu fliehen, jeder kann es ab jetzt kann!",
	alpha_card = "Du hast den Code eingesteckt!",
	destory_scp = "Du hast %i Punkte für die Zerstörung von SCP-Objekten erhalten!",
	afk = "Du bist AFK und wirst nicht spawnen",
	afk_end = "Du bist nicht mehr AFK",
	overload_cooldown = "Warte %i Sekunden, um diese Tür zu kurzzuschließen!",
	advanced_overload = "Diese Tür scheint stärker zu sein! Versuche es in %i Sekunden noch einmal",
	lockdown_once = "Der Lockdown kann nur einmal Pro Runde aktiviert werden",
}

lang.NFailed = "Zugriff auf NRegistry mit Schlüssel fehlgeschlagen: %s"
...
lang.NCRegistry = {
	...
	escapeinfo = "Du bist in %s entkommen",
	escapexp = "Du hast %i Erfahrung erhalten",
	escort = "Du wurdest eskortiert!",
	roundend = "Runde zu ende",
	nowinner = "Es gibt kein Gewinner!",
	roundnep = "Nicht genug Spieler um die Runde zu starten!",
	roundwin = "Gewinner: %s",
	roundwinmulti = "Gewinner: [RAW]",
