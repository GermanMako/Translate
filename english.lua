...
lang.NCRegistry = {
	...
	stat_049 = "Cured people: %i", // Lore says cured
	stat_066 = "Nice music played: %i",
	stat_096 = "Players killed by SCP 096: %i", // player ist singular
	stat_106 = "Victims teleported to Pocket Dimension: %i", // teleported player ist leider nicht sehr gutes Englisch
	stat_173 = "Broken necks: %i", // singular
	stat_457 = "Players burned: %i", // wie oben etc
	stat_682 = "Players killed by SCP 682",
	stat_8602 = "Players nailed to the wall: %i",
	stat_939 = "Poisoned victims of SCP 939: %i", // Loot?
	stat_966 = "Players slashed by SCP 966",
	stat_3199 = "Deaths by SCP 3199: %i",
	stat_24273 = "Mind-Controlled Players of SCP 2427-3: %i",
